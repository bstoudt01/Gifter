...
namespace Gifter.Utils
{
    ...
    public static class DbUtils
    {
        ...
        /// <summary>
        ///  Determine if the value a given column is NULL ...IsDbNull
        /// </summary>
        /// <param name="reader">A SqlDataReader that has not exhausted it's result set.</param>
        /// <param name="column">The name of the column from the result set refereed to by the reader.</param>
        ...
        /// <summary>
        ///  Determine if the value a given column is NOT NULL ... IsNotDbNull
        /// </summary>
        /// <param name="reader">A SqlDataReader that has not exhausted it's result set.</param>
        /// <param name="column">The name of the column from the result set refereed to by the reader.</param>
        ...
        //No Return Needed b\c we are MUTATING the cmd property, adding the paramaters property to it
